...
#endif
#if defined(BUILD_FONT_BACKEND)
# define BUILD_FONT_BACKEND_STRING_LITERAL_APPEND " [" BUILD_FONT_BACKEND "]"
#else
# define BUILD_FONT_BACKEND_STRING_LITERAL_APPEND ""
#endif
...
#define BUILD_TITLE_STRING_LITERAL BUILD_TITLE " (" BUILD_VERSION_STRING_LITERAL " " BUILD_RELEASE_PHASE_STRING_LITERAL ") - " __DATE__ "" BUILD_GIT_HASH_STRING_LITERAL_APPEND BUILD_MODE_STRING_LITERAL_APPEND "" BUILD_RENDERING_BACKEND_STRING_LITERAL_APPEND "" BUILD_FONT_BACKEND_STRING_LITERAL_APPEND
